...
The UK ‘lotto’ is drawn twice per week, at 8pm on Wednesday and 7.45pm Saturday evening (local time). The draw is broadcast live on YouTube and UK television, with the results published across a wide range of online and print media. You can see the historical results here: [https://www.national-lottery.co.uk/results/lotto/draw-history](https://www.national-lottery.co.uk/results/lotto/draw-history)
